            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            <h2 class="mb-0 fw-bold">{{ $siswa->nama_lengkap }}</h2>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="stat-card gradient-blue text-white p-3">
            ...
            <div class="position-relative">
                ...
                <h2 class="stat-value">{{ number_format($rataNilai, 2) }}</h2>
                <small class="opacity-75">
                    <i class="fas fa-arrow-up me-1"></i> Dari {{ $nilaiTerbaru->count() }} Mata Pelajaran
                </small>
            </div>
        </div>
    </div>
    <div class="col-md-6 col-xl-3">
        <div class="stat-card gradient-green text-white p-3">
            ...
            <div class="position-relative">
                ...
                <h2 class="stat-value">{{ $persentaseKehadiran }}%</h2>
                <div class="progress bg-white bg-opacity-25 mt-2" style="height: 5px;">
                    <div class="progress-bar bg-white" style="width: {{ $persentaseKehadiran }}%"></div>
                </div>
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-md-4 text-center">
                        ...
                        <div class="mt-3">
                            <h4 class="mb-0">{{ $persentaseKehadiran }}%</h4>
