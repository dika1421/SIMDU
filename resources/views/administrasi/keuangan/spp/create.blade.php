    ...
    <div class="content">
        <div>
            ...
            <p>
                ...
                Catat pembayaran SPP siswa dengan mudah dan cepat
            </p>
        </div>
        ...
        <form action="{{ route('administrasi.keuangan.spp.store') }}" method="POST" id="formSPP">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="kategori" id="kategori" class="form-select-modern @error('kategori') is-invalid @enderror" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" name="tanggal_bayar" id="tanggal_bayar" class="form-control-modern"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group input-group-modern">
                        ...
                        <input type="number" name="jumlah" id="jumlah" class="form-control form-control-modern"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="metode_bayar" id="metode_bayar" class="form-select-modern" required>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#formSPP').on('submit', function(e) {
            ...
            if (!siswaId || siswaId === '' || siswaId === '0' || siswaId === null || isNaN(siswaId) || parseInt(siswaId) <= 0) {
                e.preventDefault();
            ...
            if (!$('#kategori').val()) {
                e.preventDefault();
                Swal.fire({ icon: 'warning', title: 'Validasi', text: 'Silakan pilih kategori!' });
                return false;
            }
