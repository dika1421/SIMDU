                ...
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a href="<?php echo e(route('guru.nilai.index')); ?>" 
                           class="menu-item <?php echo e(request()->routeIs('guru.nilai.*') ? 'active' : ''); ?>">
                ...
                <div class="navbar-actions">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="<?php echo e(route('guru.profil.index')); ?>">Profil</a></li>
    ...
    <div class="modal fade" id="pilihSiswaRaportModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="GET" action="<?php echo e(route('guru.nilai.raport')); ?>">
                            ...
                            <select name="siswa_id" class="form-select" required>
                                ...
                                <?php $__currentLoopData = $siswaList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($s->id); ?>">
                                        <?php echo e($s->nis ?? ''); ?> - <?php echo e($s->user->name ?? $s->nama_lengkap ?? '-'); ?> 
                        ...
                        <div class="mb-3">
                            ...
                            <select name="tahun_ajaran" class="form-select" required>
                                ...
                                <?php $__currentLoopData = $tahunAjaranList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($ta); ?>" <?php echo e($ta == date('Y') . '/' . (date('Y') + 1) ? 'selected' : ''); ?>>
                                        <?php echo e($ta); ?>
