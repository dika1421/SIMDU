                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h4 class="mb-0 fw-bold">Selamat Datang, <?php echo e(Auth::user()->name ?? 'Guru'); ?>!</h4>
            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-start justify-content-between">
                    <div>
                        ...
                        <div class="stat-number mt-1"><?php echo e($totalKelas ?? 0); ?></div>
            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-start justify-content-between">
                    <div>
                        ...
                        <div class="stat-number mt-1"><?php echo e($totalSiswa ?? 0); ?></div>
                        <small class="text-info mt-1 d-block">
                            <i class="fas fa-users me-1"></i> <?php echo e($siswaPerKelas ?? 0); ?> per kelas
                        </small>
                    </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-start justify-content-between">
                    <div>
                        ...
                        <div class="stat-number mt-1"><?php echo e($totalMapel ?? 0); ?></div>
                        <small class="text-success mt-1 d-block">
            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-start justify-content-between">
                    <div>
                        ...
                        <div class="stat-number mt-1"><?php echo e(number_format($rataNilai ?? 0, 1)); ?></div>
                        <div class="progress progress-sm mt-2" style="width: 100%;">
                            <?php $persentase = min(($rataNilai ?? 0), 100); ?>
                            <div class="progress-bar bg-<?php echo e($persentase >= 75 ? 'success' : 'warning'); ?>" 
    ...
    <div class="col-lg-7">
        <div class="card card-modern h-100">
            ...
            <div class="card-body pt-3">
                <?php if(isset($jadwalHariIni) && $jadwalHariIni->count() > 0): ?>
                        ...
                        <div class="schedule-item">
                            <div class="d-flex flex-wrap align-items-start justify-content-between gap-2">
                                <div>
                                    ...
                                    <h6 class="mb-0 fw-semibold"><?php echo e($j->mapel->nama_mapel ?? 'Mata Pelajaran'); ?></h6>
                                    <small class="text-muted">
                                        <i class="fas fa-door-open me-1"></i> <?php echo e($j->ruangan ?? 'Ruang 1'); ?>

                                    </small>
                                </div>
                                <a href="<?php echo e(route('guru.absensi.index')); ?>" class="btn btn-sm btn-action btn-action-primary rounded-pill px-3">
        ...
        <div class="card card-modern h-100">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-success bg-opacity-10 text-success rounded-pill px-3 py-2">
                    <?php echo e(($hadirHariIni ?? 0) + ($sakitHariIni ?? 0) + ($izinHariIni ?? 0) + ($alfaHariIni ?? 0)); ?> Siswa
                </span>
            </div>
            <div class="card-body pt-3">
                <div class="row g-2 mb-3">
                    <div class="col-3">
                        <div class="attendance-box text-success">
                            <div class="number text-success"><?php echo e($hadirHariIni ?? 0); ?></div>
                            <div class="label">Hadir</div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="attendance-box text-warning">
                            <div class="number text-warning"><?php echo e($sakitHariIni ?? 0); ?></div>
                            <div class="label">Sakit</div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="attendance-box text-info">
                            <div class="number text-info"><?php echo e($izinHariIni ?? 0); ?></div>
                            <div class="label">Izin</div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="attendance-box text-danger">
                            <div class="number text-danger"><?php echo e($alfaHariIni ?? 0); ?></div>
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="fw-bold text-success"><?php echo e($persentaseKehadiran ?? 0); ?>%</span>
                    </div>
                ...
                <div class="grid-2">
                    <a href="<?php echo e(route('guru.absensi.index')); ?>" class="btn btn-action btn-action-primary rounded-pill text-center">
                        <i class="fas fa-plus-circle me-1"></i> Input
                    </a>
                    <a href="<?php echo e(route('guru.absensi.riwayat')); ?>" class="btn btn-action btn-outline-secondary rounded-pill text-center">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const labels = <?php echo json_encode($chartLabels ?? ['Belum Ada Data']); ?>;
    const data = <?php echo json_encode($chartData ?? [0]); ?>;
