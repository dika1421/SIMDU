...
<div class="card">
    <div class="card-body">
        <form action="<?php echo e(route('administrasi.arsip.update', $arsip->id)); ?>" method="POST" enctype="multipart/form-data" id="editForm">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                               placeholder="Contoh: ARS-001" value="<?php echo e(old('kode_arsip', $arsip->kode_arsip)); ?>">
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <?php $__currentLoopData = $kategoriList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e(old('kategori', $arsip->kategori) == $key ? 'selected' : ''); ?>><?php echo e($value); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>" 
                               placeholder="Masukkan judul/nama dokumen" value="<?php echo e(old('judul', $arsip->judul)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('tanggal_dokumen', $arsip->tanggal_dokumen ? $arsip->tanggal_dokumen->format('Y-m-d') : date('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                        ...
                        <?php if($arsip->nama_file): ?>
                            <div class="current-file mt-2">
                                <i class="fas fa-file me-2"></i>
                                <strong>File saat ini:</strong> <?php echo e($arsip->nama_file); ?>

                                <br>
                                <small class="text-muted">
                                    <i class="fas fa-calendar me-1"></i> Diupload: <?php echo e($arsip->created_at->format('d/m/Y H:i')); ?>

                                    <br>
                                    <i class="fas fa-database me-1"></i> Ukuran: <?php echo e($arsip->ukuran_file_formatted ?? round($arsip->ukuran_file / 1024, 2) . ' KB'); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                  rows="3" placeholder="Deskripsi singkat tentang dokumen ini..."><?php echo e(old('deskripsi', $arsip->deskripsi)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-end">
                <a href="<?php echo e(route('administrasi.arsip.download', $arsip->id)); ?>" class="btn btn-info me-2" target="_blank">
...
<?php echo $__env->make('administrasi.layouts.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\php\SIMDU\resources\views/administrasi/arsip/edit.blade.php ENDPATH**/ ?>