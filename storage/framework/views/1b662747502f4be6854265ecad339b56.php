...
<?php $__env->startSection('title', 'Scan RFID - Absensi'); ?>
...
<script>
    ...
    function processScan(rfid) {
        ...
        $.ajax({
            url: '<?php echo e(url("administrasi/rfid/scan")); ?>/' + currentType,
            type: 'POST',
            data: {
...
<?php echo $__env->make('administrasi.layouts.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\php\SIMDU\resources\views/administrasi/absensi/scan.blade.php ENDPATH**/ ?>