...
Route::middleware(['auth', 'check.role:kepala_sekolah'])
...
// ==================== ROUTE ADMINISTRASI ====================
Route::middleware(['auth', 'check.role:administrasi'])
    ->prefix('administrasi')
    ->name('administrasi.')
    ->group(function () {
...
// ==================== ROUTE GURU ====================
Route::middleware(['auth', 'check.role:guru'])
    ->prefix('guru')
    ->name('guru.')
    ->group(function () {
...
// ==================== ROUTE SISWA ====================
Route::middleware(['auth', 'check.role:siswa'])
    ->prefix('siswa')
    ->name('siswa.')
    ->group(function () {
