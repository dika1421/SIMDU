...
class AbsensiController extends Controller
{
    public function siswa(Request $request)
    {
        try {
            ...
            $siswa = $query->orderBy('nama')->get(); // FIX: nama bukan nama_lengkap
    ...
    {
        try {
            $guru = Guru::with('user')->where('status', 'aktif')->orderBy('nama_lengkap')->get(); // GURU tetap nama_lengkap
            $tanggal = $request->tanggal?? Carbon::now()->toDateString();
    ...
    public function rekapSiswa(Request $request)
    {
        try {
            ...
            $siswa = $query->orderBy('nama')->get(); // FIX
